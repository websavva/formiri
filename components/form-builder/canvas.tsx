  ...
  return (
    ...
    >
      <div
        {...attrs}
        className={cn(
          'bg-primary/80 absolute top-0 left-0 size-full',
          className,
        )}
        style={{
      ...
      />
      <div className="relative z-[1] size-11/12 rounded-lg space-y-5 bg-background overflow-auto shadow-2xl dark:shadow-primary/50 border-dashed border-4 border-foreground-muted dark:border-none p-5">
