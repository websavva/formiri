...
export function FormBuilderCanvas({
  ...
  return (
    <div className='relative size-full flex justify-center items-center'>
      <div
        {...attrs}
        className={cn('bg-primary/80 absolute top-0 left-0 size-full', className)}
        style={{
      ...
      <div className="flex relative z-[1] items-center justify-center size-11/12 rounded-lg text-muted-foreground bg-background text-3xl font-bold overflow-auto shadow-2xl dark:shadow-primary/50 border-dashed border-4 border-foreground-muted dark:border-none">
        Drop here
      </div>
    </div>
  );
